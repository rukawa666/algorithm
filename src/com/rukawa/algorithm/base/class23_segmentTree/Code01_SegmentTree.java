package com.rukawa.algorithm.base.class23_segmentTree;

/**
 * create by hqh on 2023/1/6
 */
public class Code01_SegmentTree {
    /**
     * 给定一个数组arr，用户希望你实现如下三个方法
     * 1、void add(int L, int R, int V)：让数组arr[L...R]上每个数都加上V
     * 2、void update(int L, int R, int V)：让数组arr[L...R]上每个数度变成V
     * 3、int sum(int L, int R)：让返回arr[L...R]这个范围整体的累加和
     * 怎么样让这个方法，事件复杂度都是O(logN)
     */
    /**
     * 举例
     *                  1~8
