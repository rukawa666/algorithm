...
public class Compare {
    ...
    public static void functionTest() {
        ...
        Code02_SizeBalancedTreeMap.SBTreeMap<Integer, Integer> sbt = new Code02_SizeBalancedTreeMap.SBTreeMap<>();
        Code03_SkipListMap.SkipListMap<Integer, Integer> skip = new Code03_SkipListMap.SkipListMap<>();
        int maxK = 500;
        int maxV = 50000;
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            if (treeMap.containsKey(querryK)) {
                ...
                if (f1 == null && (f2 != null || f3 != null || f4 != null)) {
                    System.out.println("floorKey Oops -= null");
    ...
    public static void performanceTest() {
        ...
        Code02_SizeBalancedTreeMap.SBTreeMap<Integer, Integer> sbt;
        ...
        sbt = new Code02_SizeBalancedTreeMap.SBTreeMap<>();
        skip = new Code03_SkipListMap.SkipListMap<>();
