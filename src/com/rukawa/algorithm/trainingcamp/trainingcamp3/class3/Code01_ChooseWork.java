...
public class Code01_ChooseWork {
     ...
     *     public int hard;
     * }
     * 给定一个Job类型的数组jobArr，表示所有的岗位，每个岗位都可以提供任意份工作，选工作的标准是
     * 难度不超过自身能力值得情况下，选择报酬最高的岗位
     * 给定一个int类型数组arr，表示所有人的能力，返回int类型的数组，表示每个人按照标准
     * 选工作所能获得的报酬
     */
    ...
    public static class JobComparator implements Comparator<Job> {
        ...
        public int compare(Job o1, Job o2) {
            return o1.hard != o2.hard
                    ? (o1.hard - o2.hard) : (o2.money - o1.money);
        }
    }
