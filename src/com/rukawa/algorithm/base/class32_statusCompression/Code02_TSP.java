...
public class Code02_TSP {
    ...
    public static int t1(int[][] matrix) {
        /**
         * {{1,2,3,4,5} 1}
         * 1、1->2:{{2,3,4,5},2}  2->3:{{3,4,5},3}   3->4:{{4,5},4}
         * 2、1->3:{{2,3,4,5},3}  3->2:{{2,4,5},2}   2->4:{{4,5},4}
         * 所有有重复值
         */
    ...
    // set中表示着哪些城市的集合
    // start一定在set中
    // 返回，从start出发，把set所有的城市过一遍，最终回到0这座城市，最小距离是多少
    ...
    public static int func2(int[][] matrix, int cityStatus, int start) {
        // cityStatus最右的1  cityStatus & (~cityStatus + 1)
