...
public class Code07_MergeUsers {
    ...
    public static void main(String[] args) {
        User a = new User("a", "1", "I");
        User b = new User("b", "1", "II");
        User c = new User("c", "2", "I");
        User d = new User("d", "3", "III");
        User e = new User("d", "4", "IV");
        User f = new User("e", "5", "III");
        User g = new User("e", "6", "VI");
